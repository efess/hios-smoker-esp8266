...
MODULES	= driver user mqtt modules json
EXTRA_INCDIR = include $(SDK_BASE)/../extra/include

# libraries used in this project, mainly provided by the SDK
LIBS = c gcc hal phy pp net80211 lwip wpa main ssl pwm

# compiler flags using during compilation of source files
CFLAGS = -Wa,-adhln -Os -g -O2 -std=gnu90 -Wpointer-arith -Wundef -Werror -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals -mno-serialize-volatile -D__ets__ -DICACHE_FLASH -DESP8266
CXXFLAGS = $(CFLAGS) -fno-rtti -fno-exceptions
# compiler flags for debugging
#CFLAGS = -Og -g -std=gnu90 -Wpointer-arith -Wundef -Werror -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals -mno-serialize-volatile -D__ets__ -DICACHE_FLASH -ggdb
...
# For debugger
#OBJ			:= $(patsubst %.c,$(BUILD_BASE)/%.o,$(SRC)) $(BUILD_BASE)/gdbstub/gdbstub-entry.o
...
$1/%.o: %.c
	$(vecho) "CC $$<"
	$(Q) $(CC) $(INCDIR) $(MODULE_INCDIR) $(EXTRA_INCDIR) $(SDK_INCDIR) $(CFLAGS)  -c $$< -o $$@ > $$<.xss
$1/%.o: %.cpp
	$(vecho) "C+ $$<"
...
#
#$(BUILD_BASE)/gdbstub/gdbstub-entry.o:
#	$(vecho) "DOING THE ASM THING $$<"
#	$(Q) $(CC) $(INCDIR) $(MODULE_INCDIR) $(EXTRA_INCDIR) $(SDK_INCDIR) $(CFLAGS)  -c gdbstub/gdbstub-entry.S -o $(BUILD_BASE)/gdbstub/gdbstub-entry.o
